...
SET convener_name = 'Mohd Javed Khan', 
    ...
    admission_last_date = '2026-06-06',
    total_seats = 1600
...
SELECT gen_random_uuid(), 'BBA Semester-I', 'Management', 
       ...
       60, 'Dr. Mahendra Kumar Khardiya', '9928273463', '2026-05-01', '2026-06-06'
...
SELECT gen_random_uuid(), 'AEDP (B.Com in BFSI)', 'Commerce', 
       ...
       80, 'Dr. Madhu Sudan Pardhan', '9782582267', '2026-05-01', '2026-06-06'
